...
export const Users = () => {
  ...
  const openCreateLeavePopup = (user) =>
    setIsCreateLeavePopupOpen({ show: true, user: user });

  const closeCreateLeavePopup = () =>
    setIsCreateLeavePopupOpen({ show: false, user: null });
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
          ...
          <main>
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {isAddPopupOpen && <AddUserPopup closePopup={closeAddPopup} />}
                ...
                {usersArray.map((user, index) => (
                  ...
                  >
                    ...
                    <td class="px-6 py-4">
                      <div
                        onClick={() => openCreateLeavePopup(user)}
