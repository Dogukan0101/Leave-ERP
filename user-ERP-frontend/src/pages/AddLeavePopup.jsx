...
const AddLeavePopup = ({ closePopup, user }) => {
    ...
    const [leaveEnd, setLeaveEnd ] = useState(new Date(leaveStart.getTime() + (24 * 60 * 60 * 1000)));
    ...
    const onSubmitFunction = async (event) => {
        ...
        let diffInDays = Math.round((leaveEnd.getTime() - leaveStart.getTime()) / (1000 * 3600 * 24));        
                ...
                <div className='relative bg-white rounded-lg shadow dark:bg-gray-700'>
                    ...
                    <form className="p-4 md:p-5">
                        <div className="grid gap-4 mb-4 ">
                            ...
                            <Datepicker 
                            minDate={leaveStart}
                            maxDate={new Date(leaveStart.getTime() + (24 * 60 * 60 * 1000 * 365))}
                            onSelectedDateChanged={(date) => {setLeaveStart(date)}}
                            />
                        </div>
                        ...
                        <div className="grid gap-4 mb-4 ">
                            ...
                            maxDate={new Date(leaveEnd.getTime() + (24 * 60 * 60 * 1000 * 365))}
                            onSelectedDateChanged={(date) => {setLeaveEnd(date)}}
                            />
                        </div>
